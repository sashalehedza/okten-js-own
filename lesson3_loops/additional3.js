...
console.log(
  '2. Створити пустий масив та заповнити його 50 непарними числами за допомоги циклу.'
)
array = []
for (let i = 0; i < 50; i++) {
  if (i % 2 !== 0) {
...
console.log(
  '3. Заповнити масив 20ма рандомними чисалами в діапазоні від 8 до 732 (Google: Generate random number JS)'
)
array = []
for (let i = 0; i < 20; i++) {
...
// 2. Вивести за допомогою console.log кожен третій елемент тільки якщо цей елемент є непарним.
console.log(
  '2. Вивести за допомогою console.log кожен третій елемент тільки якщо цей елемент є непарним.'
)
...
for (let i = 0; i < array.length; i++) {
  newArray[newArray.length] = array[i] * 5
}
console.log(newArray)
